...
INSERT INTO tb_cardapios (data, dia_da_semana, prato_principal, guarnicao, sobremesa, alergenos, prato_alternativo)
VALUES ('2026-09-28', 'Segunda-feira', 'Filé de Frango ao Molho Rosé', 'Batata Palha', 'Flan de Chocolate', 'glúten,lactose, Celiaco', 'Filé de Frango Grelhado com Arroz');
...
INSERT INTO tb_usuarios(username,senha,nome,cargo)
VALUES ('yasmin.pessoa', '0308', 'Yasmin Pessoa', 'Nutricionista');

INSERT INTO tb_usuarios(username,senha,nome,cargo)
VALUES ('eduardo.binoki', '123mudar','Eduardo Binoki', 'Chefe de Departamento');